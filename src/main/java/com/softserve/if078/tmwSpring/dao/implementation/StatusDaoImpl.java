...
public class StatusDaoImpl implements DaoInterface<Status> {
    ...
    public StatusDaoImpl() {
        createQuery = "Insert into 'tmw'.'Status' (name) values (?);";
        readQuery = "Select * from 'tmw'.'Status' where 'tmw'.'Status'.status_id=?;";
        readAllQuery = "Select * from 'tmw'.'Status'";
        updateQuery = "Update 'tmw'.'Status' Set name =? Where status_id=?";
        deleteQuery = "Delete From 'tmw'.'Status' Where status_id=?";
    }
